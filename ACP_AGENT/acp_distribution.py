...
_DEFAULT_HOST_ADAPTERS = (
    ...
    HostAdapterDeclaration("codex_app_server_stdio", ("existing-session", "stdio-delivery", "spawn-on-task", "client-message-correlation", "streaming-terminal-result", "cancellation", "process-serialized")),
