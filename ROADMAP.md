...
- **In progress:** M3 follow-up polish, M4 storage polish, and DX client automation.
...
| M4 | Storage | Per-room files/instructions, quotas | 🔄 files slice done; quotas/instructions next |
