...
_OVERLAY_COMMON_STYLE = (
    "<style>"
    ":root {"
    "--bg: #0B0B0A; --panel: rgba(255,255,255,0.025); --line: rgba(255,255,255,0.06);"
    "--text: #f0f0f0; --muted: #8b94a7; --accent: #85B7EB; --accent-deep: #378ADD;"
    "--accent-glow: rgba(133,183,235,0.25); --button-ink: #000;"
    "--toggle-bg: rgba(0,0,0,0.3); --shadow: 0 8px 32px rgba(0,0,0,0.2);"
    "--gradient-start: #232321; --gradient-end: #121211;"
    "}"
    "html[data-theme='light'] {"
    "--bg: #F6F5F1; --panel: rgba(255,255,255,0.78); --line: rgba(15,23,42,0.08);"
    "--text: #0f172a; --muted: #5b6474; --accent: #185FA5; --accent-deep: #0C447C;"
    "--accent-glow: rgba(24,95,165,0.2); --button-ink: #03131a;"
    "--toggle-bg: rgba(255,255,255,0.6); --shadow: 0 10px 40px rgba(15,23,42,0.08);"
    "--gradient-start: #F1F0EB; --gradient-end: #E7E5DE;"
    "}"
    "html[data-theme='system'] {"
    "--bg: #0B0B0A; --panel: rgba(255,255,255,0.02); --line: rgba(255,255,255,0.06);"
    "--text: #f0f0f0; --muted: #888; --accent: #85B7EB; --accent-deep: #378ADD;"
    "--accent-glow: rgba(133,183,235,0.25); --button-ink: #000;"
    "--toggle-bg: rgba(0,0,0,0.3); --shadow: 0 8px 32px rgba(0,0,0,0.2);"
    "--gradient-start: #232321; --gradient-end: #121211;"
    "}"
    ...
    "background: radial-gradient(circle at 50% -20%, rgba(133,183,235,0.12) 0%, transparent 58%),"
